...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.users.store'],'id' => 'formUsers','onsubmit' => "return saveButton()"]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('email', trans('quickadmin.users.fields.email').'*', ['class' => 'control-label', 'autocomplete' => 'off']) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_save'), ['class' => 'btn btn-danger','id' => 'formUsersButton']) !!}
