...
@section('content')
    ...
    {!! Form::model($user, ['method' => 'PUT', 'route' => ['admin.users.update', $user->id],'id' => 'formUsers']) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_update'), ['class' => 'btn btn-danger','id' => 'formUsersButton','onclick' => 'saveButton()']) !!}
