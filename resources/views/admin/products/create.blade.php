...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.products.store'],'id' => 'formProduct','onsubmit' => "return saveButton()"]) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_save'), ['class' => 'btn btn-danger','id' => 'formProductButton']) !!}
