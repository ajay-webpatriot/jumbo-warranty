...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.roles.store'],'id' => 'formRole','onsubmit' => "return saveButton()"]) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_save'), ['class' => 'btn btn-danger','id' => "formRoleButton"]) !!}
