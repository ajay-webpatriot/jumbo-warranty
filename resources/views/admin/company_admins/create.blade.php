...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.company_admins.store'],'id' => 'formCompanyAdmin','onsubmit' => "return saveButton()"]) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_save'), ['class' => 'btn btn-danger','id' => 'formCompanyAdminButton']) !!}
