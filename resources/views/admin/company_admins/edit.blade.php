...
@section('content')
    ...
    {!! Form::model($user, ['method' => 'PUT', 'route' => ['admin.company_admins.update', $user->id],'id' => 'formCompanyAdmin']) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_update'), ['class' => 'btn btn-danger','id' => 'formCompanyAdminButton','onclick' => 'saveButton()']) !!}
