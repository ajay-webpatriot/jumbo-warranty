...
@section('content')
    ...
    {!! Form::model($user, ['method' => 'PUT', 'route' => ['admin.company_admins.update', $user->id],'id' => 'formCompanyAdmin','onsubmit' => "return saveButton()"]) !!}

    <div class="panel panel-default">
        <div class="panel-heading headerTitle">
            @lang('quickadmin.company-admins.formTitle')
        </div>
    ...
    {!! Form::submit(trans('quickadmin.qa_update'), ['class' => 'btn btn-danger','id' => 'formCompanyAdminButton']) !!}
