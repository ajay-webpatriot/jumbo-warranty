...
@section('content')
    ...
    {!! Form::model($user, ['method' => 'PUT', 'route' => ['admin.technicians.update', $user->id],'id' => 'formTechnician']) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_update'), ['class' => 'btn btn-danger','id' => 'formTechnicianButton','onclick' => 'saveButton()']) !!}
