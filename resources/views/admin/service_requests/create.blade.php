                  ...
                  <div class="panel-body">
                    ...
                    <div class="row techDiv"  style="display: none;">
                        <div class="col-xs-12 form-group">
                            ...
                            {!! Form::select('technician_id', array('default' => trans('quickadmin.qa_please_select')), old('technician_id'), ['class' => 'form-control select2']) !!}
                            <p class="help-block"></p>
        ...
        <div class="panel panel-default">
          ...
          <div id="collapseProduct" class="panel-collapse in">
              <div class="panel-body">  
                ...
                <div class="row partsDiv" style="display: none;">
                        <div class="col-xs-12 form-group">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row serviceChargeDiv" style="display: none;">
                        <div class="col-xs-12 form-group">
                            ...
                            {!! Form::text('service_charge', old('service_charge'), ['class' => 'form-control', 'placeholder' => '','readonly' => '']) !!}
                            <p class="help-block"></p>
