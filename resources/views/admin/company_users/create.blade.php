...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.company_users.store'],'id' => 'formCompanyUsers']) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_save'), ['class' => 'btn btn-danger','id' => 'formCompanyUsersButton','onclick' => 'saveButton()']) !!}
