...
@section('content')
    ...
    {!! Form::model($company, ['method' => 'PUT', 'route' => ['admin.companies.update', $company->id],'id' => 'formCompany']) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_update'), ['class' => 'btn btn-danger','id' => 'formCompanyButton','onclick' => 'saveButton()']) !!}
