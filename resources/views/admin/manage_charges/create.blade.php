...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.manage_charges.store'],'id' => 'formManageCharges']) !!}
    ...
    {!! Form::submit(trans('quickadmin.qa_save'), ['class' => 'btn btn-danger','id' => 'formManageChargeButton','onclick' => 'saveButton()']) !!}
