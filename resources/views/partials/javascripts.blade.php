<script>
    ...
    var SUPER_ADMIN_ROLE_ID='{{ config("constants.SUPER_ADMIN_ROLE_ID") }}';
    var ADMIN_ROLE_ID='{{ config("constants.ADMIN_ROLE_ID") }}';
    var COMPANY_ADMIN_ROLE_ID='{{ config("constants.COMPANY_ADMIN_ROLE_ID") }}';
