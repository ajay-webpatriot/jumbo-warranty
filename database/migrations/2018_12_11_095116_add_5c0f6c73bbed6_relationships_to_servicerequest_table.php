...
class Add5c0f6c73bbed6RelationshipsToServiceRequestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('service_requests', function(Blueprint $table) {
            if (!Schema::hasColumn('service_requests', 'company_id')) {
                ...
                $table->foreign('customer_id', '237843_5c0a8efe79f83')->references('id')->on('users')->onDelete('cascade');
                }
